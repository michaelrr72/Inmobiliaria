...
abstract class Usuarios implements ActiveRecordInterface
{
    ...
    public function setIdPersona($v)
    {
        ...
        if ($this->id_persona !== $v) {
            $this->id_persona = $v;
            $this->modifiedColumns[UsuariosTableMap::COL_ID_PERSONA] = true;
        }

        if ($this->aPersonas !== null && $this->aPersonas->getId() !== $v) {
            $this->aPersonas = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsuariosTableMap::translateFieldName('IdPersona', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_persona = (null !== $col) ? (int) $col : null;
            $this->resetModified();
    ...
    {
        if ($this->aPersonas !== null && $this->id_persona !== $this->aPersonas->getId()) {
            $this->aPersonas = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPersonas !== null) {
                if ($this->aPersonas->isModified() || $this->aPersonas->isNew()) {
                    $affectedRows += $this->aPersonas->save($con);
                }
                $this->setPersonas($this->aPersonas);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsuariosTableMap::COL_ID_PERSONA)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aPersonas) {
                ...
                $result[$key] = $this->aPersonas->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuariosTableMap::COL_ID_PERSONA)) {
            $criteria->add(UsuariosTableMap::COL_ID_PERSONA, $this->id_persona);
        }
    ...
    /**
     * Declares an association between this object and a ChildPersonas object.
     *
     * @param  ChildPersonas $v
     * @return $this|\Usuarios The current object (for fluent API support)
     * @throws PropelException
     */
    public function setPersonas(ChildPersonas $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ChildPersonas object, it will not be re-added.
        if ($v !== null) {
            $v->addUsuarios($this);
        }
    ...
    /**
     * Get the associated ChildPersonas object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildPersonas The associated ChildPersonas object.
     * @throws PropelException
     */
    public function getPersonas(ConnectionInterface $con = null)
    {
        if ($this->aPersonas === null && ($this->id_persona !== null)) {
            $this->aPersonas = ChildPersonasQuery::create()->findPk($this->id_persona, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPersonas->addUsuarioss($this);
             */
        }
    ...
    {
        if (null !== $this->aPersonas) {
            $this->aPersonas->removeUsuarios($this);
        }
        $this->id = null;
        $this->login = null;
        $this->password = null;
