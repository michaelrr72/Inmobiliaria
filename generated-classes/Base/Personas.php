...
abstract class Personas implements ActiveRecordInterface
{
    ...
    public function setNombreCompleto($v)
    {
        ...
        if ($this->nombre_completo !== $v) {
            ...
            $this->modifiedColumns[PersonasTableMap::COL_NOMBRE_COMPLETO] = true;
        }
    ...
    public function setCorreo($v)
    {
        ...
        if ($this->correo !== $v) {
            $this->correo = $v;
            $this->modifiedColumns[PersonasTableMap::COL_CORREO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PersonasTableMap::translateFieldName('NombreCompleto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre_completo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PersonasTableMap::translateFieldName('Correo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = PersonasTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PersonasTableMap::COL_NOMBRE_COMPLETO)) {
            $modifiedColumns[':p' . $index++]  = 'nombre_completo';
        }
        if ($this->isColumnModified(PersonasTableMap::COL_CORREO)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setNombreCompleto($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PersonasTableMap::COL_NOMBRE_COMPLETO)) {
            $criteria->add(PersonasTableMap::COL_NOMBRE_COMPLETO, $this->nombre_completo);
        }
        if ($this->isColumnModified(PersonasTableMap::COL_CORREO)) {
            $criteria->add(PersonasTableMap::COL_CORREO, $this->correo);
        }
    ...
    public function setUsuarioss(Collection $usuarioss, ConnectionInterface $con = null)
    {
        ...
        foreach ($usuariossToDelete as $usuariosRemoved) {
            $usuariosRemoved->setPersonas(null);
        }
