...
class UsuariosTableMap extends TableMap
{
     ...
     */
    const COL_ID_PERSONA = 'usuarios.id_persona';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Login', 'Password', 'Administrador', 'IdPersona', ),
        self::TYPE_CAMELNAME     => array('id', 'login', 'password', 'administrador', 'idPersona', ),
        self::TYPE_COLNAME       => array(UsuariosTableMap::COL_ID, UsuariosTableMap::COL_LOGIN, UsuariosTableMap::COL_PASSWORD, UsuariosTableMap::COL_ADMINISTRADOR, UsuariosTableMap::COL_ID_PERSONA, ),
        self::TYPE_FIELDNAME     => array('id', 'login', 'password', 'administrador', 'id_persona', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Login' => 1, 'Password' => 2, 'Administrador' => 3, 'IdPersona' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'login' => 1, 'password' => 2, 'administrador' => 3, 'idPersona' => 4, ),
        self::TYPE_COLNAME       => array(UsuariosTableMap::COL_ID => 0, UsuariosTableMap::COL_LOGIN => 1, UsuariosTableMap::COL_PASSWORD => 2, UsuariosTableMap::COL_ADMINISTRADOR => 3, UsuariosTableMap::COL_ID_PERSONA => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'login' => 1, 'password' => 2, 'administrador' => 3, 'id_persona' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_persona', 'IdPersona', 'INTEGER', 'personas', 'id', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Personas', '\\Personas', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':id_persona',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuariosTableMap::COL_ID_PERSONA);
        } else {
