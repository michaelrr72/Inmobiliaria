...
class PersonasTableMap extends TableMap
{
     ...
     */
    const COL_NOMBRE_COMPLETO = 'personas.nombre_completo';

    /**
     * the column name for the correo field
     */
    const COL_CORREO = 'personas.correo';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'NombreCompleto', 'Correo', ),
        self::TYPE_CAMELNAME     => array('id', 'nombreCompleto', 'correo', ),
        self::TYPE_COLNAME       => array(PersonasTableMap::COL_ID, PersonasTableMap::COL_NOMBRE_COMPLETO, PersonasTableMap::COL_CORREO, ),
        self::TYPE_FIELDNAME     => array('id', 'nombre_completo', 'correo', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'NombreCompleto' => 1, 'Correo' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'nombreCompleto' => 1, 'correo' => 2, ),
        self::TYPE_COLNAME       => array(PersonasTableMap::COL_ID => 0, PersonasTableMap::COL_NOMBRE_COMPLETO => 1, PersonasTableMap::COL_CORREO => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nombre_completo' => 1, 'correo' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('correo', 'Correo', 'VARCHAR', true, 80, null);
    } // initialize()
  ...
  array (
...
), 'CASCADE', 'CASCADE', 'Usuarioss', false);
    } // buildRelations()
    /**
     * Method to invalidate the instance pool of all tables related to personas     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PersonasTableMap::COL_NOMBRE_COMPLETO);
            $criteria->addSelectColumn(PersonasTableMap::COL_CORREO);
        } else {
