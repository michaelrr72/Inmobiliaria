...
class ComentariosTableMap extends TableMap
{
     ...
     */
    const COL_COMENTARIO = 'comentarios.comentario';

    /**
     * the column name for the usuario field
     */
    const COL_USUARIO = 'comentarios.usuario';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Comentario', 'Usuario', 'IdApartamento', ),
        self::TYPE_CAMELNAME     => array('id', 'comentario', 'usuario', 'idApartamento', ),
        self::TYPE_COLNAME       => array(ComentariosTableMap::COL_ID, ComentariosTableMap::COL_COMENTARIO, ComentariosTableMap::COL_USUARIO, ComentariosTableMap::COL_ID_APARTAMENTO, ),
        self::TYPE_FIELDNAME     => array('id', 'comentario', 'usuario', 'id_apartamento', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Comentario' => 1, 'Usuario' => 2, 'IdApartamento' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'comentario' => 1, 'usuario' => 2, 'idApartamento' => 3, ),
        self::TYPE_COLNAME       => array(ComentariosTableMap::COL_ID => 0, ComentariosTableMap::COL_COMENTARIO => 1, ComentariosTableMap::COL_USUARIO => 2, ComentariosTableMap::COL_ID_APARTAMENTO => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'comentario' => 1, 'usuario' => 2, 'id_apartamento' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('usuario', 'Usuario', 'VARCHAR', false, 20, null);
        $this->addColumn('id_apartamento', 'IdApartamento', 'INTEGER', false, null, null);
    } // initialize()
  ...
  array (
...
), 'CASCADE', 'CASCADE', 'Apartamentoss', false);
    } // buildRelations()
    /**
     * Method to invalidate the instance pool of all tables related to comentarios     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ComentariosTableMap::COL_COMENTARIO);
            $criteria->addSelectColumn(ComentariosTableMap::COL_USUARIO);
